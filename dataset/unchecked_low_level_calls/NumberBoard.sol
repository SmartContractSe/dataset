...
contract NumberBoard { 
    ...
    function NumberBoard() { houseOwner = msg.sender; } 
    ...
    function canAcceptBuyNow(uint theNum, address buyer) constant returns (bool) { 
        ...
        numCard.buyNowPrice = 0; numCard.buyNowActive = false; 
    ...
    function cancelBid(uint theNum) { 
        ...
        deadbids[numCard.currentBidder] += numCard.currentBid; numCard.currentBid = 0;
