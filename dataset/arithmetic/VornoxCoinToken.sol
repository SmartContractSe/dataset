...
pragma solidity ^0.4.11;
  ...
  contract AbstractToken is Token, SafeMath {
     ...
     */
    address public fund = 0x10D18e988542E749a949243017F134a7D0F54c53;
  ...
  contract VornoxCoinToken is AbstractToken {
    /**
     ...
     */
    address public owner = 0x42C09ef0b88768991926C2a765a86c74AAc41864;
    ...
    /**
     * Create new VornoxCoin Token Smart Contract, make message sender to be the
     * owner of smart contract, issue given number of tokens and give them to
     * message sender.
     */
    function VornoxCoinToken () {
      tokensCount = INITIAL_TOKENS_COUNT;
      accounts [owner] = INITIAL_TOKENS_COUNT;
      // owner = msg.sender;
      // fund = fundAddress;
    }
